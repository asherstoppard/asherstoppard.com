...
import { Layout, Splash, SiteHeader, SiteFooter } from '../components'
...
const Homepage = () => (
  ...
  >
    ...
    <p>
      ...
      experiences based on research and analysis of quantitive and qualitative
    ...
    <ul>
      ...
      <li>UX/UI and wireframing and design experience</li>
    </ul>
    <h2>Experience</h2>
    ...
    <h2>Applications seen by 277,404,055 users a year. See calculation.</h2>
    <SiteFooter />
  </Layout>
)
